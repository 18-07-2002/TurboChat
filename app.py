...
title = """<h1 align="center">TurboChat</h1>"""
...
#     inputs="text",
#     outputs="text",
#     title="Turbo Chatbot: Interactive Conversations and Contextual Responses",
#     description="Just type your query in form of prompt in the text box and press enter and your turbo Chatbot will Reply to your text "
# )
